...
dojo_media_library = dict((app, find_app_media_dir_and_url(app))
...
def _build_urlmap():
    ...
    for app in dojo_media_apps:
        ...
        for elem in root_and_urls:
            ...
            seen[url] = root
    base_url = "dojo-media" # dojango_settings.BASE_MEDIA_URL
...
url_patterns = patterns('django.views.static', *urls)